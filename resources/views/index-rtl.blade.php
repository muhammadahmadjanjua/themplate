@extends('layouts/master-rtl-layout')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <div class="dropdown">
                                <a class="dropdown-toggle btn btn-light btn-sm" href="#" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><span class="text-muted">Monthly<i
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <div class="dropdown">
                                <a class="dropdown-toggle btn btn-light btn-sm" href="#" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><span class="text-muted">Weekly<i
                                            class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <div class="dropdown">
                                <a class="dropdown-toggle btn btn-light btn-sm" href="#" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><span class="text-muted">Yearly<i
                                            class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>
        ...
        <div class="col-xl-4">
                ...
                <div class="card-body">
                    <div class="alert alert-warning border-0 d-flex align-items-center" role="alert">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ URL::asset('pricing-basic') }}"
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-7">
                            ...
                            <div class="mt-4">
                                <a href="{{ URL::asset('pricing-basic') }}" class="btn btn-primary">Upgrade
                                    Account!</a>
                            </div>
                        </div>
                        <div class="col-sm-5">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-end">
                        <div class="dropdown">
                            <a class="dropdown-toggle text-reset" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                        ...
                        <div class="col-sm-7">
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <h5>$12,582<small class="badge badge-soft-success font-13 ms-2">+15%</small>
                                    </h5>
                                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <div class="dropdown d-inline">
                                <a class="dropdown-toggle text-reset mb-3" href="#" data-bs-toggle="dropdown"
                                ...
                                <tr>
                                    <th class="rounded-start" style="width: 15px;">
                                        <div class="form-check">
                                            <input class="form-check-input font-size-16" type="checkbox" value=""
                                                id="checkAll">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}"
                                                    class="avatar-sm img-thumbnail h-auto rounded-circle" alt="Error">
                                            </div>
                                            <div>
